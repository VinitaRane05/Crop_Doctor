    ...
    if st.button("Analyze"):
        ...
        if plant:
            ...
            ">
                ...
                {f"<div class='desc-box'>{plant_summary}</div>" if plant_summary.strip() else ""}

                <a href="{plant_wiki}" class="wikipedia-link" target="_blank">
                    🔗 More about this plant on Wikipedia
                </a>
